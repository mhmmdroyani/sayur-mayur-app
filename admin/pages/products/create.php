...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error_msg)) {
        $stmt = mysqli_prepare($conn, "INSERT INTO produk (nama, harga, stock, kategori, berat, gambar, deskripsi) VALUES (?, ?, ?, ?, ?, ?, ?)");
        mysqli_stmt_bind_param($stmt, "sdiiids", $nama, $harga, $stock, $kategori, $berat, $gambar, $deskripsi);
...
<head>
  ...
  <title>Tambah Produk - Admin SAYUR MAYUR</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .form-input:focus, .form-select:focus, .form-textarea:focus { border-color: #22c55e; outline: none; box-shadow: 0 0 0 4px rgba(34, 197, 94, 0.15); background: white; }
            ...
            <form method="POST" enctype="multipart/form-data">
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" name="nama" class="form-input" placeholder="Kubis Premium" required>
                </div>
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="number" name="harga" class="form-input" placeholder="25000" step="100" min="0" required>
                </div>

                <div class="form-group">
                  <label class="form-label">Stok <span class="form-label-required">*</span></label>
                  <input type="number" name="stock" class="form-input" placeholder="100" min="0" required>
                </div>
              </div>

              <div class="form-group">
                <label class="form-label">Berat (kg)</label>
                <input type="number" name="berat" class="form-input" placeholder="1.5" step="0.1" min="0" value="1">
              </div>
              ...
              <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-textarea" placeholder="Deskripsi lengkap produk..."></textarea>
              </div>
